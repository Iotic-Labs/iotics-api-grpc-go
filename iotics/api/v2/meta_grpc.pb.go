...
const (
	MetaAPI_SparqlQuery_FullMethodName   = "/iotics.api.v2.MetaAPI/SparqlQuery"
	MetaAPI_SparqlUpdate_FullMethodName  = "/iotics.api.v2.MetaAPI/SparqlUpdate"
	MetaAPI_ExplorerQuery_FullMethodName = "/iotics.api.v2.MetaAPI/ExplorerQuery"
)
...
func (c *metaAPIClient) SparqlQuery(ctx context.Context, in *SparqlQueryRequest, opts ...grpc.CallOption) (MetaAPI_SparqlQueryClient, error) {
	stream, err := c.cc.NewStream(ctx, &MetaAPI_ServiceDesc.Streams[0], MetaAPI_SparqlQuery_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *metaAPIClient) SparqlUpdate(ctx context.Context, in *SparqlUpdateRequest, opts ...grpc.CallOption) (*SparqlUpdateResponse, error) {
	...
	err := c.cc.Invoke(ctx, MetaAPI_SparqlUpdate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *metaAPIClient) ExplorerQuery(ctx context.Context, in *ExplorerRequest, opts ...grpc.CallOption) (MetaAPI_ExplorerQueryClient, error) {
	stream, err := c.cc.NewStream(ctx, &MetaAPI_ServiceDesc.Streams[1], MetaAPI_ExplorerQuery_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func _MetaAPI_SparqlUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MetaAPI_SparqlUpdate_FullMethodName,
	}
...
var MetaAPI_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "iotics.api.v2.MetaAPI",
	...
	Metadata: "iotics/api/v2/meta.proto",
}
