...
const (
	MetaAPI_SparqlQuery_FullMethodName   = "/iotics.api.MetaAPI/SparqlQuery"
	MetaAPI_SparqlUpdate_FullMethodName  = "/iotics.api.MetaAPI/SparqlUpdate"
	MetaAPI_ExplorerQuery_FullMethodName = "/iotics.api.MetaAPI/ExplorerQuery"
)
